...
module.exports = multer({ storage: storage }).single('image'); // appel "multer" à laquelle on passe l'objet "storage", ainsi que de la méthode "single" car c'est un fichier unique qui est une image
